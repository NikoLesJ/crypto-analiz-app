...
async function fetchCoinInfo(query) {
    ...
    try {
        ...
        if (!response.ok) throw new Error('API limit reched');
...
function displayCoinInfo(coin) {
                ...
                <div class="status">
                    ...
                    <div class="container">
                        ...
                        <div class="item">
                            ...
                            <div class="links">
                                <a href="${coin.tickers[2].trade_url}">Bybit</a>
                ...
                <div class="status">
                    ...
                    <div class="container">
                        <div class="item">
                            ...
                            <div class="links">
                                <a href="${coin.links.homepage}" target="_blank" rel="noopener noreferrer">Visit</a>
                                <a href="${coin.links.whitepaper}" target="_blank" rel="noopener noreferrer">Whitepaper</a>
                            </div>
                        </div>
                        <div class="item">
                            <p class="str">Community</p>
                            <div class="links">
                                <a href="https://x.com/${coin.links.twittwer_screen_name}" target="_blank" rel="noopener noreferrer">Twitter</a>
                                <a href="https://facebook.com/${coin.links.facebook_username}" target="_blank" rel="noopener noreferrer">Facebook</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    coinDesc.innerHTML = coin.description.en || '<p class="red"> Asset description not aviable!</p>';
}
